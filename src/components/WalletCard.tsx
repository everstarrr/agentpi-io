    ...
    return (
        ...
        inverted ? 'border-orange' : 'border-sulu')}>
            <div className={clsx("rounded-[26px] py-[7px] px-[15px] text-[15px] bg-[#1FA49F0D] w-fit sm:text-xl lg:text-2xl ",
                inverted ? 'text-orange' : 'text-sulu')}>
                {role}
            </div>
            ...
            <div className="flex gap-[7px] items-end">
                <Image src={inverted ? "/bullet2.svg" : '/bullet.svg'} alt="Tokens" className="sm:w-12 sm:h-12" width={27} height={27}/>   
                ...
                <span className={clsx("text-sm sm:text-base lg:text-xl font-medium leading-[19px] sm:leading-[21px] lg:leading-[27px]", inverted ? 'text-orange' : 'text-sulu')}>tokens</span> 
            </div>
        </div>
    )
}